...
public class CorpusKMLWriter {
      ...
      protected Map<opennlp.fieldspring.tr.topo.Location, Integer> locationCounts;
      protected Map<opennlp.fieldspring.tr.topo.Location, List<String> > contexts;
    ...
    public CorpusKMLWriter(Corpus<? extends Token> corpus) {
      ...
      private void countLocationsAndPopulateContexts(Corpus<? extends Token> corpus) {
          locationCounts = new HashMap<opennlp.fieldspring.tr.topo.Location, Integer>();
          contexts = new HashMap<opennlp.fieldspring.tr.topo.Location, List<String> >();
                    ...
                    if(token.isToponym()) {
                        ...
                        if((!outputGoldLocations && toponym.getAmbiguity() > 0 && toponym.hasSelected())
                           || (outputGoldLocations && toponym.hasGold())) {
                            opennlp.fieldspring.tr.topo.Location loc;
      ...
      protected void write(XMLStreamWriter out) throws Exception {
          ...
          for (opennlp.fieldspring.tr.topo.Location loc : locationCounts.keySet()) {
      ...
      protected void writePlacemarkAndPolygon(XMLStreamWriter out, opennlp.fieldspring.tr.topo.Location loc) throws Exception {
      ...
      protected void writeContexts(XMLStreamWriter out, opennlp.fieldspring.tr.topo.Location loc) {
          int i = 0;
