...
object RegularCellIndex {
  /* SCALABUG: Why do I need to specify RegularCellIndex as the return type
     ...
     [error] /Users/benwing/devel/fieldspring/src/main/scala/opennlp/fieldspring/geolocate/MultiRegularCell.scala:273: overloaded method apply needs result type
