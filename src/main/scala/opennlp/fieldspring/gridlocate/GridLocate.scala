...
import opennlp.fieldspring.util.textdbutil
...
import opennlp.fieldspring.worddist._
...
class RandomGridLocateDocumentStrategy[
    ...
    def read_stopwords(filehand: FileHandler, stopwords_filename: String,
      ...
      def compute_stopwords_filename(filename: String) = {
        if (filename != null) filename
          ...
          val tgdir = FieldspringInfo.get_fieldspring_dir
  ...
  a default list of English stopwords (stored in the Fieldspring distribution)
  is used.""")
