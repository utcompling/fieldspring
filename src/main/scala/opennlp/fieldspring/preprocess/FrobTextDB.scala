...
import opennlp.fieldspring.util.printutil.warning

import opennlp.fieldspring.gridlocate.DistDocument
...
//Fieldspring.  OUTDIR is the directory to store the results in, which must not
